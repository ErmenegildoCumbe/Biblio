...
<div class="row bg-title">
        ...
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <h4 class="page-title">Confirmação de Reserva do Livro {{$reserva->livro->titulo}}</h4> </div>
        <!-- /.page title -->
        <!-- .breadcrumb -->
...
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-info">
            <div class="panel-heading"> Confirme os Dados do Emprestimo</div>
            <div class="panel-wrapper collapse in" aria-expanded="true">
                <div class="panel-body">
                    <form action="{{'/reserva/confirmar/'.$reserva->id }}" class="form-material" method="POST">
                            {{ csrf_field() }}
                            <input type="hidden" name="livro" value="{{ $reserva->livro->id }}">
                        <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="titulo" readonly name="titulo" class="form-control" value="{{ $reserva->livro->titulo }}"> 
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="autor" name="autor" readonly class="form-control" value="{{ $reserva->livro->autor }}">
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nome" name="nome" class="form-control" value="{{ $reserva->estudante->nome }} " readonly> 
                                        @if ($errors->has('nome'))
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nr_estudante" name="nr_estudante" class="form-control" value="{{ $reserva->estudante->nr_estudante }}" readonly>
